...
# --- 2. FUNÇÕES DE DADOS (Com Cache e Segurança) ---
@st.cache_resource
...
with tab_sucesso:
    ...
    # Formatação das colunas da tabela para exibição
...
with tab_perdas:
    ...
    if df_p.empty:
        ...
        with cp2:
            ...
            st.plotly_chart(px.bar(df_p_op, x='Operador', y='Valor Estimado', color_discrete_sequence=['#FF4B4B']), use_container_width=True)
